...
// will only see deployed updates on subsequent visits to a containers, after all the
// existing tabs open on the containers have been closed, since previously cached
            ...
            if (navigator.serviceWorker.controller) {
              ...
              console.log(
                'New content is available and will be used when all ' +
                  'tabs for this containers are closed. See http://bit.ly/CRA-PWA.'
              );
